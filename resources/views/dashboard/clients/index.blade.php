                            ...
                            @foreach ($clients as $index=>$client)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('dashboard.clients.orders.create', $client->id)}}" class="btn btn-success">@lang('site.add_order')</a>
                                        @else
                                        <a href="#" class="btn btn-success disabled">@lang('site.add_order')</a>
                                        @endif
                                    </td>
                                    <td>
